<script>
    ...
    for(var i=0; i<1; i++){
        ...
        var categoryData = ['services','homes','jobs','cars','bikes','education','mobiles & tablets',
            ...
            'commercial real estate','salon at home', 'pets & pet care','intercity','home & lifestyle','entertainment',
            'community','events','matrimonial'];
        var categoryId=[10001,10002,10003,10004,10005,10006,10007,10008,10009,10010,10011,10012,10013,10014,10015,
        ...
        var newClass = ['fa-wrench','fa-home','fa-briefcase','fa-car','fa-motorcycle','fa-graduation-cap','fa-tablet','fa-bed','fa-television',
            'fa-smile-o','fa-paint-brush','fa-building','fa-female','fa-paw','fa-map-marker','fa-building-o',
