<div class="dataindex-main">
    <div class="col-lg-3 leftsidebar" id="CategoryMenu">
        <script>
            ...
            for(var i=0; i<1; i++){
                ...
                var categoryData = ['services','homes','jobs','cars','bikes','education','mobiles & tablets','furniture & decor','electronics and appliances',
                'kids & toys','sports, hobbies, fashion','commercial real estate','salon at home', 'pets & pet care','intercity','refurbished phones',
    ...
    <div class="col-lg-9 rightsidebar" id="mainWindow">
            ...
            ?>
        <div class="container">Block For Advertisement</div>
