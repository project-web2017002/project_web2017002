<div class="row">
    ...
    <div class="col-md-10 col-sm-12">
        <form name="communityForm" autocomplete="off" method="post">
            <table class="table">
                ...
                <tr>
                    <td>
                        <div class="input-group">
                            ...
                            <input type="text" name="community-user-contact" id="community-user-contact" placeholder="Enter Contact Number" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                ...
                <tr>
                    <td>
                        <div id="validatecommunityForm" class="btn btn-success btn-block">Validate Form</div>
                    </td>
                    <td>
                        <input type="submit" name="submitcommunityForm" id="submitcommunitylForm" value="Continue" class="btn btn-danger btn-block hidden">
                    </td>
                </tr>
            </table>
        </form>
