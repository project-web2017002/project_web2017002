...
if($page == '' || $page == 1){
    ...
    if ($num <= 0) {
        ...
        <div class="container tab-content">
            ...
            <div class="row tab-pane fade in" style="text-transform: capitalize" id="test8">
                <?php
                while ($getdata = mysqli_fetch_array($getALL_products1)) {
                    $file = substr($getdata[2], 20);
                    if (($handle = fopen($file, "r")) !== FALSE) {
                        while (($data = fgetcsv($handle, 4096, ",")) !== FALSE) {
                            $row++;
                            if ($row == 1) {
                                ...
                                for ($i = 0; $i < sizeof($row_arr); $i++) {
                                    ...
                                    if ($getcity != $city) {
                                        ...
                                        ?>
                                        <div class="col-sm-12" style="padding: 10px" id="tes4">
                                            <div class="row" style="cursor: pointer"
                                                 onclick="ViewProduct(<?php echo $this_pro_id; ?>);">
