        ...
        <div class="row" style="text-align: -webkit-center; text-transform: capitalize">
            ...
            foreach($files as $file) { $counter++;
                if ($counter == 6) { break; }
                        ...
                        while (($data = fgetcsv($handle, 4096, ",")) !== FALSE) { $row++;
                            if ($row == 1) { continue; } else { $row=0;
                                ...
                                $this_pro_id = $fetch[0]; $image = $fetch[3];
                                $field = implode(",", $data);
                                ...
                                elseif ($category == 10002 || $category == 10012){
                                    $title = "Home for ".$row_arr[2]; $cost = $row_arr[7]; $use_r_name = $row_arr[8]; $da_te = $row_arr[17];
                                }
                                ...
                                else{ $title = ''; $cost = ''; $use_r_name = ''; $da_te = ''; }
                                ?>
