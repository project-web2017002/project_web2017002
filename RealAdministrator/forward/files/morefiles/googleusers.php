...
<table class="table table-striped table-hover">
    ...
    <tr style="text-align: center">
        <td></td>
        <td colspan="2"><h3><strong>Total Registered Users: <span class="badge"><?php echo $num_users ?></span></strong></h3></td>
        <td></td>
    </tr>
    </thead>
    <tbody>
    ...
    while($fetch_all_users=mysqli_fetch_array($select_all_users)){
        ...
        $usertype = $fetch_all_users[1];
        ?>

        <tr id="<?php echo $user_id ?>">
            <td><h4><?php echo $usertype ?></h4></td>
